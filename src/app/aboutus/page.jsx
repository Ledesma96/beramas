export const metadata = {
    title: 'Bera positivo - Nosotros',
    description: 'Descubre quiénes somos y nuestra dedicación a tu comodidad y estilo. En Bera positivo, nos apasiona ofrecerte muebles excepcionales que transformen tu hogar. Con un equipo comprometido y experto, nos esforzamos por brindarte experiencias únicas y productos de alta calidad. Explora nuestra historia, valores y el compromiso con la excelencia en cada detalle. Confía en nosotros para proporcionarte sillones, mesas y muebles que reflejen tu personalidad y estilo de vida. Únete a nosotros mientras creamos espacios acogedores y elegantes que te encantarán.',
    keywords: 'Muebles de calidad, Experiencia en muebles, Diseño de interiores, Comodidad en el hogar, Estilo de vida moderno, Fabricantes de muebles, Innovación en mobiliario, Compromiso con la excelencia, Confort y estilo, Historia de la empresa, Valores empresariales, Expertos en muebles, Pasión por el diseño, Transformación del hogar, Visión de la empresa, Compromiso con el cliente, Estilo y funcionalidad, Decoración de interiores, Personalización de muebles, Líderes en mobiliario'
  }
const page = () => {
  return (
    <>
        <div className='aboutus-container'>
            <div className='aboutus-container_div'>
                ...
                <div className='aboutus-container_div_div'>
                    ...
                    <p className='aboutus-container_div_p'> Somos Beramasssillones una empresa con mas de 10 años en el rubro. Contamos con fabricación propia para otorgar a cada creación el confort y la funcionalidad que sus espacios merecen.<br></br>                               Trabajamos con los mejores materiales del mercado para garantizarle a nuestros clientes la seguridad de cada producto como merecen. Nuestra política se basa en la atención personalizada para lograr la conformidad y satisfacción de cada cliente.</p>
                </div>
            </div>
