...
export const metadata = {
  ...
  keywords: 'Bera, Berazategui, Muebles, Sofás, Berazategui muebles, Muebles Berazategui, Sofás y Mesas, Muebles para el Hogar, Decoración de Interiores, Diseño de Interiores, Mobiliario Moderno, Tienda de Muebles Online, Ofertas de Muebles, Envío Gratuito de Muebles, Confort y Estilo para tu Hogar, Experiencia de Compra Online, Envios al interior, Sofás, Sillones, Esquineros, Sillas, Mesas, Mesas y sillas, Deco y hogar'
}
